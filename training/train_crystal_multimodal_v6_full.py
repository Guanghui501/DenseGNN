...
def main():
    ...
    for fold_idx, split in enumerate(splits):
        ...
        # Input order: offset, voronoi_ridge_area, atomic_number, charge, edge_indices, text
        input_keys = ['offset', 'voronoi_ridge_area', 'atomic_number', 'edge_indices']
        ...
        # Graph inputs: [offset, voronoi, atomic_number, edge_indices]
        # Final order: [offset, voronoi, atomic_number, charge, edge_indices, text]
